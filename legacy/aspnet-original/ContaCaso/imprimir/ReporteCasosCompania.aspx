<%@ Page Title="" Language="C#" MasterPageFile="~/ConsulCaso9/MasterPage.master" AutoEventWireup="true" CodeFile="ReporteCasosCompania.aspx.cs" Inherits="ContaCaso_GastosInvestigacion" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div  class="FormatoDiv"> 
     ...
     <table style="width: 100%;">
                  ...
                  <asp:Label ID="Label7" runat="server" Text="Seleccione Una Compania" ></asp:Label>
                              <br />
