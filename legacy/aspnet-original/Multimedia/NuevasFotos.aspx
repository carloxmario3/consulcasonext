<%@ Page Title="" Language="C#" MasterPageFile="~/ConsulCaso9/MasterPage.master" AutoEventWireup="true" CodeFile="NuevasFotos.aspx.cs" Inherits="Multimedia_NuevasFotos" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
   ...
   <asp:HyperLink ID="HyperLink1" runat="server" Font-Bold="True" 
      ...
      <asp:Label ID="Label2" runat="server" 
            Text="Subir Foto" CssClass="titulos" ></asp:Label>
    ...
    FocusOnLoad="True"
    Width="500px" MaxFileInputsCount="1" AllowedFileExtensions=".jpg">
