...
public class ClaseReclamantes
{
    ...
    public void nuevo(ref string info_operacion)
    {
        ...
        try
        {
            ...
            sds.InsertCommand = "INSERT INTO Tabla_Reclamantes (Id_laborales,Id_afiliado,Id_Numero_Caso,Apellido,Barrio,Cedula,Celular,Ciudad,Direccion,Nombre,Parentesco,Telefono) VALUES (@1Id_laborales,@1Id_afiliado,@1Id_Numero_Caso,@1Apellido,@1Barrio,@1Cedula,@1Celular,@1Ciudad,@1Direccion,@1Nombre,@1Parentesco,@1Telefono)";
            ...
            sds.InsertParameters.Add("1Parentesco", System.Data.DbType.String, "defecto");
            ...
            sds.InsertParameters["1Parentesco"].DefaultValue = this.Parentesco;
    ...
    public void leeridreclamante(string caso, ref string id_afiliado, ref string label_mensaje)
    {
        ...
        try
        {
            ...
            sds.SelectCommand = "Select Id_reclamantes FROM  Tabla_Reclamantes  WHERE (Id_Numero_Caso = @1Id_Numero_Caso)";
