...
public class ClaseRecuinve
{
    ...
    public string Id_Recinve { get; set; }
    ...
    public void actualizarruta(string codigo, ref string label_mensaje)
    {
        ...
        try
        {
            ...
            sds.UpdateCommand = "UPDATE  Tabla_Recuinve SET Ruta = @1Ruta WHERE (Id_Recinve = @codigo)";
    ...
    public void nuevo(ref string info_operacion)
    {
        ...
        try
        {
            ...
            sds.InsertCommand = "INSERT INTO Tabla_Recuinve (Tipodedocumento,Id_numero_de_Caso,Ruta,SubidoPor) VALUES (@1Tipodedocumento,@1Id_numero_de_Caso,@1Ruta,@1SubidoPor)";
            ...
            sds.InsertParameters.Add("1SubidoPor", System.Data.DbType.String, "defecto");
            ...
            sds.InsertParameters["1SubidoPor"].DefaultValue = this.SubidoPor;
