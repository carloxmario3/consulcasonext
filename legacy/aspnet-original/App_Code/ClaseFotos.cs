...
public class ClaseFotos
{
    ...
    public string Id_Fotos { get; set; }
    ...
    public void traerfoto(string idinformeok, ref string label_mensaje)
    {
        ...
        try
        {
            ...
            sds.SelectCommand = "Select * FROM  Tabla_Fotos  WHERE (Id_informe = @1Id_informe)";
    ...
    public void actualizarruta(string codigoanexo, ref string label_mensaje)
    {
        ...
        try
        {
            ...
            sds.UpdateCommand = "UPDATE  Tabla_Fotos SET Ruta = @1Ruta WHERE (Id_Fotos = @anexos)";
    ...
    public void nuevo(ref string info_operacion)
    {
        ...
        try
        {
            ...
            sds.InsertCommand = "INSERT INTO Tabla_Fotos (Id_informe,Tipodedocumento,Ruta,Id_estadodocus) VALUES (@1Id_informe,@1Tipodedocumento,@1Ruta,@1Id_estadodocus)";
